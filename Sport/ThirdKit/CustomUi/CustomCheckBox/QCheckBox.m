...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"select_empty.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"select_press.png"] forState:UIControlStateSelected];
