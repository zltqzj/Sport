...
@property(assign,nonatomic) NSInteger ID;  // 活动提交之前为空，Activity主键
@property(assign,nonatomic) NSInteger user_id;  //#用户ID
@property(strong,nonatomic) NSString* flag;   // #1:有效 2:删除
@property(strong,nonatomic) NSDate* start_date; // 活动开始时间
@property(strong,nonatomic) NSDate* start_date_local; //
...
@property(strong,nonatomic) NSString* private; // # 1:不公开,0:公开
...
@property(strong,nonatomic) NSNumber* like_count; // 喜欢人数
@property(strong,nonatomic) NSNumber* comments_count; // 评论人数
@property(strong,nonatomic) NSNumber* awards_count; // 此活动达成的奖励数量
@property(strong,nonatomic) NSString* device; // ios
@property(strong,nonatomic) NSDate* lastsynctime; // 上次同步时间
